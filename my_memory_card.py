...
questions_list.append(
        Question('Какая страна является домом для кенгуру?', 'Австралия', 'Америка', 'Россия', 'Япония'))
questions_list.append(
        Question('Сколько планет в нашей Солнечной системе?', 'Восемь', 'Четыре', 'Семь', 'Одна'))
questions_list.append(
        Question('У какого единственного плода семена расположены на внешней кожуре?', 'Клубника', 'Банан', 'Гранат', 'Яблоко'))
questions_list.append(
        Question('Сколько струн у скрипки?', 'Четыре', 'Семь', 'Пять', 'Шесть'))
...
def ask(q: Question):
    ...
    answers[0].setStyleSheet('color: #1A7817;')
    answers[1].setStyleSheet('color: #0619A7;')
    answers[2].setStyleSheet('color: #FF6700;')
    answers[3].setStyleSheet('color: #FF00A3;')
    lb_Question.setText(q.question) # вопрос
    lb_Question.setStyleSheet('color: #800000;')
    lb_Correct.setText(q.right_answer) # ответ 
    lb_Question.setStyleSheet('color: #431772;')
